...
`@compliance-theater/json-viewer` allows you to display JSON data in a readable and user-friendly format. But it's not just limited to JSON - you can use it to view **ANY** kind of data. The library is highly customizable and supports 100% TypeScript, making it easy to modify and tailor to your specific needs.
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab label="npm">``` npm install @compliance-theater/json-viewer @mui/material @emotion/react @emotion/styled ```</Tab>
  <Tab label="yarn">``` yarn add @compliance-theater/json-viewer @mui/material @emotion/react @emotion/styled ```</Tab>
  <Tab label="pnpm">``` pnpm add @compliance-theater/json-viewer @mui/material @emotion/react @emotion/styled ```</Tab>
</Tabs>
